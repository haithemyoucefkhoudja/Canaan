...
export default function Page() {
  const [gameType, setGameType] = useState<"original" | "character" | null>(null)
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-red-50 p-4">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <Card className="bg-white shadow-lg border-2 border-gray-200">
            <CardHeader>
              <CardTitle className="text-xl font-semibold">Game History</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-blue-600">{user.totalGamesPlayed}</div>
                ...
                <div>
                  <div className="text-2xl font-bold text-red-600">{user.gamesLost}</div>
  ...
  if (gameType === "character" && selectedLevel) {
    return <CharacterBingo onBack={handleBack} level={selectedLevel} onLevelComplete={handleLevelComplete} />
  }

  if (gameType === "original" && selectedLevel) {
    return <BingoGame onBack={handleBack} level={selectedLevel} onLevelComplete={handleLevelComplete} />
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-red-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Palestinian Historical Bingo</h1>
          <p className="text-gray-600 text-lg">Test your knowledge of Palestinian history and culture</p>
        </div>
        ...
        {!canPlayGame() && (
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-4 text-center">
              <p className="text-red-700 font-medium">You need hearts to play! Hearts regenerate every 2 hours.</p>
            </CardContent>
          </Card>
        )}
