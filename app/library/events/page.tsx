...
export default function EventsPage() {
  ...
  if (isError) {
    return <p className="text-destructive mt-4 dark:text-red-400">Failed to load events: {error.message}</p>;
  }
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {(!events || events.length === 0) ? (
                  <p className="text-muted-foreground mt-4 dark:text-slate-400 text-center">No events have been added yet.</p>
              ) : (
                  ...
                  >
                      ...
                      <div className={`w-[calc(50%-2rem)] z-20 ${index % 2 === 0 ? 'mr-auto' : 'ml-auto'}`}>
                        <EventCard 
                            event={event}
