...
const MapComponent = dynamic(
	() => import("@/components/library/MapComponent"),
	{
		ssr: false,
...
const placeholderEvent = {
	...
	description:
		"Loading the event description from the database. This is a placeholder.",
				...
				<Card className="mb-8 border-yellow-500 bg-yellow-50/50">
					<CardContent className="pt-6">
						<p className="text-center text-yellow-700">
							Could not load data from the database. Displaying placeholder
							structure.
						</p>
					</CardContent>
				</Card>
