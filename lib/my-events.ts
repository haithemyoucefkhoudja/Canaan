...
export const testEvents: HistoricalEvent[] = [
	// Event 1: Cross-Border Attacks from Gaza
	{
		...
		outcome:
			"Influential work of self-criticism calling for scientific and educational reform in the Arab world.",
		storyElements: [
			{
	...
	},
	{
		...
		outcome:
			"Cycle of attacks and Israeli reprisals leading to the 1956 Suez Crisis",
		storyElements: [
			{
				...
				options: [
					"Palestinian refugees begin infiltrating Israel for economic reasons.",
					"Palestinian refugees start crossing into Israel to access their former lands.",
					"Displaced Palestinians cross the border to retrieve property.",
					"Palestinians begin cross-border movements for economic survival.",
				],
				correctAnswer:
					"Palestinian refugees begin infiltrating Israel for economic reasons.",
			},
			{
				...
				position: { x: 400, y: 100 },
				options: [
					"Egypt sponsors and trains armed Fedayeen units.",
					"The Egyptian government starts supporting militant groups in Gaza.",
					"Fedayeen groups receive training and backing from Egypt.",
					"Egypt organizes armed Palestinian units for cross-border operations.",
				],
			...
			},
			{
				...
				options: [
					"Fedayeen launch cross-border attacks from Gaza.",
					"Militants conduct raids from Gaza into Israeli territory.",
					"Armed groups initiate attacks on Israel from the Gaza Strip.",
					"Fedayeen carry out cross-border assaults on Israeli targets.",
				],
			...
			},
			{
				...
				options: [
					"Israel responds with military reprisal operations.",
					"The Israeli army carries out retaliatory raids.",
					"Israel launches counter-attacks in response to the raids.",
					"Military reprisals are conducted by Israeli forces.",
				],
			...
			},
			{
				...
				options: [
					"The cycle of violence contributes to the 1956 Suez Crisis.",
					"Escalating attacks and reprisals lead to the Suez War.",
					"The ongoing conflict culminates in the 1956 Suez Crisis.",
					"The tensions result in the outbreak of the Suez Crisis.",
				],
				correctAnswer:
					"The cycle of violence contributes to the 1956 Suez Crisis.",
			},
		...
		actors: [
			"Egypt Non-Governmental",
			"Palestine Non-Governmental",
			"Israel Governmental",
		],
		...
		outcomeOptions: [
			"Cycle of attacks and Israeli reprisals leading to the 1956 Suez Crisis.",
			"A lasting ceasefire agreement was signed.",
			"The United Nations established a permanent peacekeeping force.",
			"The attacks ceased without a clear resolution.",
		],
	},
	{
		title: "Cross-Border Attacks from Gaza",
		...
		storyConnections: [
			{
				from: 0,
				to: 1,
				relationship: "which provides for a",
				color: "#a1c4fd",
			},
			{
				from: 0,
				to: 2,
				relationship: "and constitutes it as a",
				color: "#a1c4fd",
			},
		],
	...
	{
		title:
			"Great Britain Announces Formal Recognition of Extended Kingdom of Jordan and de jure Recognition of Israel Simultaneously",
		date: "27 April 1950",
