...
var supabase_1 = require("../lib/supabase/supabase");
var quizzes = [
    {
        ...
        game: {
            ...
            outcome: "The British government pledges support for the establishment of a 'national home for the Jewish people' in Palestine.",
            storyElements: [
                {
                    ...
                    correctAnswer: "During World War I, British Foreign Secretary Arthur Balfour sends a letter to Baron Rothschild, a leader of the British Jewish community.",
                },
                {
                    ...
                    correctAnswer: "The letter, known as the Balfour Declaration, states that the British government views with favour the establishment of a national home for the Jewish people in Palestine.",
                },
                {
                    ...
                    correctAnswer: "A crucial proviso in the declaration states that nothing shall be done which may prejudice the civil and religious rights of existing non-Jewish communities.",
                },
                {
                    ...
                    correctAnswer: "The declaration becomes a foundational document for the Zionist movement and later shapes the controversial terms of the British Mandate for Palestine.",
                },
            ],
            storyConnections: [
    ...
    },
    {
        ...
        game: {
            ...
            date: "1947-1949",
            location: "Palestine",
            outcome: "The mass displacement and dispossession of over 700,000 Palestinians, creating a foundational and ongoing refugee crisis.",
            storyElements: [
                {
                    ...
                    correctAnswer: "Following the 1947 UN Partition Plan for Palestine, a civil war erupts between Jewish and Arab communities, setting the stage for a major conflict.",
                },
                {
                    ...
                    correctAnswer: "Between December 1947 and 1949, during the 1948 Palestine War, over 700,000 Palestinians are displaced from their homes through flight and expulsion.",
                },
                {
                    ...
                    correctAnswer: "Hundreds of Palestinian villages and urban neighborhoods are depopulated and subsequently destroyed or resettled by the newly established State of Israel.",
                },
                {
                    ...
                    correctAnswer: "The event, known as the 'Nakba' (Catastrophe), becomes a foundational element of Palestinian national identity and the origin of the unresolved 'right of return' issue.",
                },
            ],
            storyConnections: [
    ...
    },
    {
        ...
        game: {
            ...
            location: "Egypt",
            outcome: "A political victory for Egypt, but a humiliating failure for Britain and France, marking the end of their era as global superpowers and increasing US/Soviet influence.",
            storyElements: [
                {
                    ...
                    correctAnswer: "Egyptian President Gamal Abdel Nasser nationalizes the Suez Canal, transferring control from British and French interests to the Egyptian state.",
                },
                {
                    ...
                    correctAnswer: "In a secret agreement, Britain, France, and Israel conspire to launch a military intervention to retake the canal and depose Nasser.",
                },
                {
                    ...
                    correctAnswer: "Despite military successes, the invasion is met with overwhelming international condemnation, especially from the United States and the Soviet Union.",
                },
                {
                    ...
                    correctAnswer: "Under immense financial pressure from the US and military threats from the USSR, the invading forces are forced to withdraw, solidifying Nasser's position as a hero of Arab nationalism.",
                },
            ],
            storyConnections: [
    ...
    },
    {
        ...
        game: {
            ...
            outcome: "The creation of the Palestinian Authority with limited self-rule, but the failure to resolve final status issues, leading to the process eventually collapsing.",
            storyElements: [
                {
                    ...
                    correctAnswer: "After decades of conflict, secret talks facilitated by Norway begin between Israel and the Palestine Liberation Organization (PLO).",
                },
                {
                    ...
                    correctAnswer: "The process leads to a major breakthrough: The PLO officially recognizes the State of Israel, and Israel recognizes the PLO as the representative of the Palestinian people.",
                },
                {
                    ...
                    correctAnswer: "The accords create the Palestinian Authority (PA) for limited self-governance in the West Bank and Gaza, but defer contentious issues like Jerusalem, settlements, and borders.",
                },
                {
                    ...
                    correctAnswer: "Despite initial hope and a Nobel Peace Prize, the process is derailed by extremist violence, the assassination of Yitzhak Rabin, and ultimately collapses, leaving core issues unresolved.",
                },
            ],
            storyConnections: [
    ...
    },
    {
        ...
        game: {
            ...
            outcome: "A severe humanitarian crisis in Gaza, mass displacement, and an ongoing, intense military conflict with major international diplomatic repercussions.",
            storyElements: [
                {
                    ...
                    correctAnswer: "On October 7, 2023, Hamas launches an unprecedented surprise attack on Israel, involving thousands of rockets and a large-scale ground infiltration.",
                },
                {
                    ...
                    correctAnswer: "The initial assault results in a high number of Israeli casualties and the taking of numerous civilian and military hostages into Gaza.",
                },
                {
                    ...
                    correctAnswer: "In response, Israel declares war and initiates a massive military campaign, including intense aerial bombardments and a ground invasion of the Gaza Strip.",
                },
                {
                    ...
                    correctAnswer: "The conflict creates a severe humanitarian crisis in Gaza, with widespread destruction and mass displacement, prompting intense international calls for a ceasefire and aid.",
                },
            ],
            storyConnections: [
                { from: 0, to: 1, relationship: "results in" },
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase_1.supabase.from("game").insert(quizzes).select()];
                case 1:
                    ...
                    // Handle success
                    console.log("Successfully inserted ".concat(data.length, " games!"));
                    return [2 /*return*/];
            }
        });
    });
