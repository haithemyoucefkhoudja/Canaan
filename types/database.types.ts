...
export type NewAchievement = Database['public']['Tables']['achievement']['Insert'];
export type UserGameStats = Database['public']['Tables']['user_game_stats']['Row'];
...
export type UserRewardBox = Database['public']['Tables']['user_reward_box']['Row'];
